...
<body>
    ...
    <main class="container vh-100 mt-5">
        <div>
            ...
            ?>
            <a href="http://localhost/BTTH03/route/index.php?controller=music&action=add" class="btn btn-success">Thêm mới</a>
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                ...
                ?>
                    <tbody>
                        <tr>
                            <th scope="row"><?=$music->getid()?></th>
                            <td><?=$music->getname(); ?></td>
                            <td><a href=""><i class="bi bi-pencil-square"></i></a></td>
                            <td>
                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#author<?= $music->getid(); ?>"><i class="bi bi-trash-fill"></i>
                                </button>
                                <div class="modal fade" id="music<?=$music->getid(); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Delete the author has id: <?=$music->getid(); ?>
                                            </div>
